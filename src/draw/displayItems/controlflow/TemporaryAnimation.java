...
public class TemporaryAnimation implements DisplayableItem {
	...
	public TemporaryAnimation(LAnimaRPEventPublisher parseActionTrigger, long durationDisplayed, Supplier<DisplayableItem> displayableItemGenerator) {
	...
	public static TemporaryAnimation newInstance(Element e, LAnimaRPContext context) {
		return new TemporaryAnimation(
