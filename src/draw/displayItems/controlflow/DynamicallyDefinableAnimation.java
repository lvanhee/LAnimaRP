...
public class DynamicallyDefinableAnimation implements DisplayableItem{
	...
	private DynamicallyDefinableAnimation(Map<String, Supplier<DisplayableItem>> animationPerElement, StringVariable sv) {
	...
	public static DynamicallyDefinableAnimation newInstance(Element e, LAnimaRPContext context) {
		...
		return new DynamicallyDefinableAnimation(animationPerElement, sv);
