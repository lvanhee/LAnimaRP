...
public class HeartBeatMonitor implements DisplayableItem {
	...
	private BoundedIntegerVariable pace;
	private boolean flatCurve=false;
	private final Color c;
	
	private double cyclePeakFactor = 1;
	private int numberOfIterationsInTotal = 0;
	private BooleanVariable isIrregular;
	...
	public HeartBeatMonitor(final Rectangle r, BoundedIntegerVariable pace, BooleanVariable irregular, Color c) {
		...
		Thread t = new Thread(new Runnable() {
			...
			int indexOnDisplay = new Random().nextInt((int)r.getWidth());
			...
			public void run() {
				...
				while(!terminationRequested)
				{
					...
					Color shadingColor = new Color(0f,0f,0f,0.2f);
					if(indexOnDisplay==0)
